...
On lines containing full-width characters (Japanese, CJK, etc.), the cursor may land slightly off from the click position. See [Known limitations](/en/reference/known-limitations/).
:::
