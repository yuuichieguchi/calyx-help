...
Calyx is open-source software distributed under the [MIT License](/en/legal/license/).
...
The full text appears on the [License](/en/legal/license/) page.
...
See the [License](/en/legal/license/) page for details.
